...
public abstract class AbstractActivableFilter implements Filter {
	...
	registry = VolatilerRegistryListener.getVolatileRegistry(filterConfig.getServletContext());

	String activeByDefault = filterConfig.getInitParameter(FILTER_ACTIVE_BY_DEFAULT);
	registry.register(this, activeByDefault == null || Boolean.valueOf(activeByDefault));
    ...
    protected abstract void doDoFilter(ServletRequest request, ServletResponse response, FilterChain chain)
